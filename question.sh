...
#
sed "12 s/\([0-9]\)\//0\1\//g" data.csv | sed "1,11 s/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/g" | sed "12 s/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9][0-9][0-9]\)/\3-\2-\1/g" | sed "y/acn/ACN/" | sed "s/,/./g" | sed "s/;/,/g" | sed "s/,,/,\\\N,/g" | sed "s/,N/,\\\N/g" | sed "s/\,$/,\\\N/g"
